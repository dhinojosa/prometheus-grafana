...
Quarkus coffee fulfillment app. Mirrors the same domain and endpoints as `coffee-spring`, with metrics exposed for Prometheus scraping at `/q/metrics`.
...
Prometheus metrics are exposed at `http://localhost:8081/q/metrics`.
